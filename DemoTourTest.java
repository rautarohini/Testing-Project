...
public class DemoTourTest {

	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
		
		
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\user\\Desktop\\Selenium jar//chromedriver.exe");
...
//    // all links
	    w1.findElement(By.linkText("SIGN-ON")).click();
	      ...
	      w1.navigate().back(); 
	      System.out.println("links work successful");
	  ...
	  //current url of page
		...
		// login
			...
			// register form
			     w1.findElement(By.linkText("REGISTER")).click();
		         w1.findElement(By.name("firstName")).sendKeys("Rohini");
			     w1.findElement(By.name("lastName")).sendKeys("Raut");
			     w1.findElement(By.name("phone")).sendKeys("7774028281");
			     w1.findElement(By.name("userName")).sendKeys("rautrohini07@gmail.com");
			     ...
			     w1.findElement(By.name("email")).sendKeys("rautrohini07@gmail.com");
	    ...
	    //selenium
			...
			Thread.sleep(2000);
			 ...
			 w1.navigate().back(); 
			 System.out.println("scroll bar done");
		     ...
		     Select s1=new Select(w1.findElement(By.name("title")));
		      ...
		      w1.findElement(By.name("email")).sendKeys("rautrohini07@gmail.com"); //login
		      w1.findElement(By.name("password")).sendKeys("123456");
		      w1.findElement(By.name("submit")).click();
	       ...
	       //Telecom project
		    ...
		    w1.findElement(By.id("email")).sendKeys("rautrohini07@gmail.com"); 
		    ...
		    w1.findElement(By.xpath("//*[@id=\"customer_id\"]")).sendKeys("641120"); //code
		  ...
		  //payment gateway
		      ...
		      Select p=new Select(w1.findElement(By.name("month")));
		      p.selectByVisibleText("05");
		      Select x=new Select(w1.findElement(By.name("year")));
		      x.selectByVisibleText("2025");
		  ...
		  //seo
		    ...
		    w1.navigate().back();
		    System.out.println("demotour successfully done");
	}
